...
import com.wd.tech.presenter.FaceIdLoginPresenter;
...
public class DetecterActivity extends Activity implements OnCameraListener, View.OnTouchListener, Camera.AutoFocusCallback {
    ...
    private FaceIdLoginPresenter faceIdLoginPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        faceIdLoginPresenter = new FaceIdLoginPresenter(new loginP());
